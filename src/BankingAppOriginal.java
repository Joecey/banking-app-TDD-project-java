...
/**
 * IMPORTANT: THIS IS THE ORIGINAL FILE BEFORE ANY REFACTORING WAS DONE
 *
 ...
 */
public class BankingAppOriginal {

	public static void main(String[] args) {
	    // Create a new banking application instance
	    BankingAppOriginal bank = new BankingAppOriginal();
